...
public class Language
{
	...
	public void  Language(WebDriver driver,Reporter1 R1 , ImageAttachmentInDocument1 IA2)throws Exception
	{  
		this.driver=driver;
		this.R1=R1;
		this.IA1=IA2;
	...
	public   void AddLanguage(String Language_Name)throws Exception
	 {
		  ...
		  findElement(By.linkText("Languages"));	 
		   ...
		   IA1.PasteImage("Language Page - Clicking on Languages",str);
		    ...
		    findElement(By.id("language_name")).sendKeys(Language_Name);
